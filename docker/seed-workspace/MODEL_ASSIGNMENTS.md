...
The Hermes container registers this route as the default custom endpoint during startup. It still needs a real Verde-compatible API key before model calls can succeed.
