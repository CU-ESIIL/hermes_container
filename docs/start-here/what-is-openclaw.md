...
Hermes is a collaborative workspace for environmental data science.
...
Hermes adds a structured workspace on top of that runtime.

This is where the system becomes more than a container:

- Hermes provides the chat and control UI.
...
Hermes is useful when it helps a team move through those activities with more clarity. Files stay organized. Agent work stays visible. Human review stays explicit.

## The Simple Mental Model

Think of Hermes like this:
...
1. [First 10 Minutes](first-10-minutes.md)
2. [Launch Locally](../use/launch-locally.md)
3. [Where Files Go](../use/where-files-go.md)
4. [Choose Your Path](user-paths.md)
...
Hermes does not replace scientific judgment, peer review, or human responsibility.
